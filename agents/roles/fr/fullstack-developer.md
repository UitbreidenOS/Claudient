...
description: "Architecture de pipeline de données — ETL/ELT batch et streaming, conception de modèle dbt, Spark, Kafka, qualité des données, architecture medallion"
---
