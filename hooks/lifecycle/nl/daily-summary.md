# Hook: Dagelijks sessieoverzicht

Schrijft automatisch een samenvatting van wat Claude in de sessie heeft bereikt naar een lokaal logbestand wanneer de sessie eindigt. Handig voor het volgen van AI-ondersteund werk zonder handmatig journaliseren.
...
Maakt `~/.claude/sessions/2026-05-20.md` met vermeldingen zoals:
...
## Uitgebreide versie (met git diff-samenvatting)

```bash
# Voeg toe aan de hook na de basisvermelding:
