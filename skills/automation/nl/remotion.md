...
## Wanneer activeren
- Een productdemovideo maken vanuit code (geen videoeditor nodig)
- Geanim ateerde release notes of changelogs bouwen
- Een uitlegvideo genereren voor een functie of proces
- Een datavisualisatievideo maken op basis van dynamische gegevens
- Videogeneratie automatiseren in een CI/CD-pipeline

## Wanneer NIET gebruiken
- Een scherm opnemen — gebruik Loom of OBS
- Bestaand videomateriaal bewerken — gebruik DaVinci Resolve of Premiere
- Real-time videostreaming
- Eenvoudige GIF — gebruik een GIF-tool voor statische animaties
...
**Gebruiker:** Maak een 15-secondenvideo voor een SaaS-factuurhulpmiddel. Toon: 1) logo-intro, 2) factuurscherm maken, 3) verzenden en volgen, 4) CTA.
