...
## Wanneer activeren
- PowerPoint-presentaties genereren uit gestructureerde inhoud of gegevens
- Word-documenten maken op basis van templates of gegevensbronnen
- Excel-spreadsheets bouwen met opgemaakte gegevens, formules en grafieken
- Documentgeneratie automatiseren in een CI/CD of datapipeline
- Markdown of gestructureerde gegevens converteren naar professionele Office-documenten

## Wanneer NIET gebruiken
- Eenvoudige PDF-generatie — gebruik een PDF-bibliotheek (WeasyPrint, reportlab)
- Google Slides/Docs — gebruik de Google Workspace MCP
- Interactieve dashboards — gebruik een BI-tool (Metabase, Grafana)
- Real-time gezamenlijke bewerking — gebruik Google Workspace of Office 365 rechtstreeks

## Instructies

### PowerPoint-presentatie (python-pptx)
...
**Gebruiker:** Ik moet een maandelijks boardrapport als DOCX genereren uit onze metriekgegevens.
