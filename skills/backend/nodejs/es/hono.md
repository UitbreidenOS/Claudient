...
## When to activate
- Construir una nueva API con Hono en Cloudflare Workers, Bun o Node.js
- Migrar una API de Express a Hono para despliegue edge
- Configurar validación Zod con el middleware validador de Hono
- Usar Hono RPC para comunicación client/server type-safe
- Implementar middleware (auth, CORS, rate limiting) en Hono

## When NOT to use
- Rutas API de Next.js — usa la skill nextjs
- Backend completo con integración ORM pesada — Hono funciona pero Express/Fastify tienen más ecosistema
- Monolito grande con cadenas de middleware complejas — considera NestJS
