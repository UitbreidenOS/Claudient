...
## When to activate
- Construir una aplicación web o móvil con Firebase como backend
- Configurar Firebase Authentication (correo electrónico, Google, Apple, teléfono)
- Escribir reglas de seguridad de Firestore y modelos de datos
- Construir Cloud Functions para Firebase
- Implementar características en tiempo real con oyentes de Firestore o Realtime Database

## When NOT to use
- Aplicaciones basadas en PostgreSQL — use las skills supabase o neon
- Datos relacionales complejos — el modelo de documento de Firestore tiene límites para datos altamente relacionales
- Aplicaciones que requieren consultas SQL complejas — Firestore no es una base de datos SQL
