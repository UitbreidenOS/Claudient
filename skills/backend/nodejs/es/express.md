...
## When to activate
- Construcción de una API REST con Express.js
- Adición de middleware (auth, validación, CORS, rate limiting) a una aplicación Express
- Configuración de la estructura del proyecto y el manejo de errores para un servicio Express de producción
- Migración de callbacks a async/await en manejadores de Express
- Adición de validación de solicitud y rutas tipificadas a una aplicación Express

## When NOT to use
- Despliegues edge — usa la skill hono (Cloudflare Workers)
- Framework full-stack — usa la skill nextjs
- Microservicios de alto rendimiento que necesitan rendimiento bruto — considera Fastify
