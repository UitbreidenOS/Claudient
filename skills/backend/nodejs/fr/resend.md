...
## When to activate
- Envoi d'e-mails transactionnels à partir d'une application Node.js/Next.js
- Création de modèles d'e-mail avec React Email
- Implémentation des flux de vérification d'e-mail, réinitialisation de mot de passe ou notification
- Gestion des webhooks Resend (événements de livraison, rebond, plainte)
- Migration de SendGrid, Postmark ou AWS SES vers Resend

## When NOT to use
- Campagnes de marketing par e-mail — utilisez un ESP dédié comme Mailchimp ou Brevo
- Bulletins d'information par e-mail — Resend est pour les e-mails transactionnels, pas le marketing en masse
- SMS — utilisez Twilio
