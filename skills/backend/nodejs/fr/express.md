...
## When to activate
- Construction d'une API REST avec Express.js
- Ajout de middleware (auth, validation, CORS, rate limiting) à une application Express
- Configuration de la structure du projet et de la gestion des erreurs pour un service Express en production
- Migration des callbacks vers async/await dans les gestionnaires Express
- Ajout de validation de requête et de routes typées à une application Express

## When NOT to use
- Déploiements edge — utilisez la compétence hono (Cloudflare Workers)
- Framework full-stack — utilisez la compétence nextjs
- Microservices haute performance nécessitant des performances brutes — envisagez Fastify
