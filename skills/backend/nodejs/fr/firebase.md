...
## When to activate
- Construction d'une application web ou mobile avec Firebase comme backend
- Configuration de Firebase Authentication (email, Google, Apple, téléphone)
- Rédaction de règles de sécurité Firestore et modèles de données
- Création de Cloud Functions pour Firebase
- Implémentation de fonctionnalités en temps réel avec les écouteurs Firestore ou la base de données en temps réel

## When NOT to use
- Applications soutenues par PostgreSQL — utilisez les compétences supabase ou neon
- Données relationnelles complexes — le modèle de document de Firestore a des limites pour les données hautement relationnelles
- Applications nécessitant des requêtes SQL complexes — Firestore n'est pas une base de données SQL
