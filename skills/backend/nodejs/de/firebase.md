...
## When to activate
- Erstellung einer Web- oder mobilen App mit Firebase als Backend
- Einrichtung von Firebase Authentication (E-Mail, Google, Apple, Telefon)
- Schreiben von Firestore-Sicherheitsregeln und Datenmodellen
- Erstellung von Cloud Functions für Firebase
- Implementierung von Echtzeit-Features mit Firestore-Listenern oder Realtime Database

## When NOT to use
- PostgreSQL-basierte Apps — verwenden Sie die supabase oder neon Skills
- Komplexe relationale Daten — Firestores Dokumentmodell hat Grenzen für hochrelationale Daten
- Apps, die komplexe SQL-Abfragen erfordern — Firestore ist keine SQL-Datenbank
