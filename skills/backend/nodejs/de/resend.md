...
## When to activate
- Versand von Transaktions-E-Mails aus einer Node.js/Next.js-Anwendung
- Erstellung von E-Mail-Vorlagen mit React Email
- Implementierung von E-Mail-Verifizierungs-, Passwort-Reset- oder Benachrichtigungsflows
- Bearbeitung von Resend-Webhooks (Zustellungs-, Bounce-, Beschwerde-Ereignisse)
- Migration von SendGrid, Postmark oder AWS SES zu Resend

## When NOT to use
- Marketing-E-Mail-Kampagnen — verwenden Sie einen dedizierten ESP wie Mailchimp oder Brevo
- E-Mail-Newsletter — Resend ist für transaktionale, nicht für Massen-Marketing-E-Mails
- SMS — verwenden Sie Twilio
