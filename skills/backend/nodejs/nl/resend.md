...
## When to activate
- Verzending van transactionele e-mails vanuit een Node.js/Next.js-toepassing
- Maken van e-mailsjablonen met React Email
- Implementatie van e-mailverificatie, wachtwoordherstel of meldingsflows
- Afhandeling van Resend-webhooks (bezorgings-, bounce-, klachtenevents)
- Migratie van SendGrid, Postmark of AWS SES naar Resend

## When NOT to use
- Marketing e-mailcampagnes — gebruik een toegewijde ESP zoals Mailchimp of Brevo
- E-mailnieuwsbrieven — Resend is voor transactionele e-mails, niet voor massamarketing
- SMS — gebruik Twilio
