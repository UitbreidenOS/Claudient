...
## When to activate
- Bouwen van een web- of mobiele app met Firebase als backend
- Instellen van Firebase Authentication (e-mail, Google, Apple, telefoon)
- Schrijven van Firestore-beveiligingsregels en gegevensmodellen
- Bouwen van Cloud Functions voor Firebase
- Implementeren van real-time-features met Firestore-listeners of Realtime Database

## When NOT to use
- PostgreSQL-ondersteunde apps — gebruik de supabase of neon skills
- Complexe relationele gegevens — Firestores documentmodel heeft beperkingen voor zeer relationele gegevens
- Apps die complexe SQL-query's vereisen — Firestore is geen SQL-database
