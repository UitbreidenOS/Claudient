...
## When to activate
- Bouwen van een nieuwe API met Hono op Cloudflare Workers, Bun of Node.js
- Migreren van een Express-API naar Hono voor edge-implementatie
- Instellen van Zod-validatie met Hono's validator-middleware
- Gebruiken van Hono RPC voor type-safe client/server-communicatie
- Implementeren van middleware (auth, CORS, rate limiting) in Hono

## When NOT to use
- Next.js API-routes — gebruik de nextjs-skill
- Volledig backend met zware ORM-integratie — Hono werkt maar Express/Fastify hebben meer ecosysteem
- Grote monoliet met complexe middleware-chains — overweeg NestJS
