...
## When to activate
- Bouwen van een REST-API met Express.js
- Toevoegen van middleware (auth, validatie, CORS, rate limiting) aan een Express-app
- Instellen van projectstructuur en foutafhandeling voor een productie-Express-service
- Migratie van callbacks naar async/await in Express-handlers
- Toevoegen van request-validatie en getypeerde routes aan een Express-app

## When NOT to use
- Edge-implementaties — gebruik de hono-skill (Cloudflare Workers)
- Full-stack framework — gebruik de nextjs-skill
- Hoogdoorvoer-microservices die ruwe prestaties nodig hebben — overweeg Fastify
