...
## Wanneer activeren
- Documenteren wat werd gebouwd zonder geschreven spec (technische schuld in documentatie)
- Een nieuwe PM onboarden die ongedocumenteerde functies erft
- Voorbereiding op een product handoff of teamtransitie
- Controleren wat daadwerkelijk werd gebouwd versus wat oorspronkelijk was bedoeld
- Documentatie maken vanuit een prototype dat zonder specs is verzonden

## Wanneer NIET gebruiken
- Schrijven van een nieuwe PRD vóór het bouwen — gebruik de product-manager-toolkit skill
- Documenteren van een API voor externe consumenten — gebruik de README generator
- Creëren van gebruikersgericht documentatie — ander publiek en formaat

## Instructies

### Volledige feature PRD-extractie
...
**Gebruiker:** We verzonden een invoice-functie 6 maanden geleden zonder spec. Nieuwe PM voegt zich aan. Genereer de PRD vanuit de code.
