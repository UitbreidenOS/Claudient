...
# Git Worktree Vaardigheid

## Wanneer activeren
- Tegelijkertijd aan twee functies werken zonder branches om te schakelen
- Een PR beoordelen terwijl u uw huidige werk intact houdt
- Een langdurige test op één branch uitvoeren terwijl u code op een ander schrijft
- Claude Code gebruiken om in een geïsoleerde omgeving aan een taak te werken
- Productie hotfixen terwijl u midden in een functie op uw hoofdbranch bent

## Wanneer NIET gebruiken
- Eenvoudig branchwisselen zonder werk in uitvoering — gebruik gewoon `git checkout`
- Eenmalige contextsisolatie — een nieuwe clone is eenvoudiger voor dat
- Worktrees tussen machines delen — worktrees zijn alleen lokaal
...
### Parallelle ontwikkelingswerkstroom
...
**Gebruiker:** Ik ben midden in een complexe refactor en ben net opgeroepen over een productiebug. Ik kan mijn wijzigingen niet opslaan omdat er te veel in de lucht is. Hoe ga ik hiermee om met worktrees?
...
De worktree-benadering is voor complexe situaties strikt beter dan opslaan — stash pop-conflicten zijn een echt risico; worktrees hebben geen enkele.
