...
Un prompt structuré pour les tâches d'analyse de données — requêtes SQL, interprétation des métriques, analyse de cohortes et recommandations actionnables basées sur les données.
