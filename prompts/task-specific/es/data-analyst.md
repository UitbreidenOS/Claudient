...
Un prompt estructurado para tareas de análisis de datos — consultas SQL, interpretación de métricas, análisis de cohortes y recomendaciones accionables basadas en datos.
