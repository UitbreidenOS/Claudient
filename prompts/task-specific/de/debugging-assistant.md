...
Ein strukturiertes Prompt für systematisches Debugging — führt Claude durch Root-Cause-Analyse statt Trial-and-Error-Fixes.
...
Fügen Sie diese Vorlage in Claude Code ein, wenn Sie einen Bug haben. Füllen Sie jeden Abschnitt aus, bevor Sie abschicken — die Disziplin des Ausfüllens der Abschnitte offenbart oft die Grundursache, bevor Claude überhaupt antwortet.
...
- Je spezifischer Sie über "wann es passiert" sind, desto schneller finden Sie es
- Fügen Sie den vollständigen Stack Trace ein, nicht nur die letzte Zeile
- "Es funktioniert nicht" ist kein Symptom — beschreiben Sie beobachtbares Verhalten
- Wenn der Bug intermittierend ist: beschreiben Sie die Häufigkeit und etwaige Muster
